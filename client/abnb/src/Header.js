    ...
    <div>
      <header className="flex justify-between">
        <Link to={"/"} className="flex items-center gap-1">
          ...
          <span className="font-bold text-xl">AABnB</span>
        </Link>
        ...
        >
          ...
          <div className="bg-gray-100 rounded-full border border-gray-200 overflow-hidden">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="20"
              width="20"
